...
public class SecretResource {
    ...
    private final Logger logger = LoggerFactory.getLogger(SecretResource.class);
    ...
    public ResponseEntity<SecretResponse> getUserSecret() {
        ...
        logger.info("Un utilisateur a accédé à un secret d'utilisateur");
    ...
    public ResponseEntity<SecretResponse> getAdminSecret() {
        ...
        logger.info("Un utilisateur a accédé à un secret d'admin");
        return ResponseEntity.ok()
            .header("Cache-Control", "no-store")
            .body(secretResponse);
    }
